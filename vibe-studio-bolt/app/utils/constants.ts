...
export const PROVIDER_LIST = llmManager.getAllProviders().filter(p => p.name === 'Inixa');
export const DEFAULT_PROVIDER = llmManager.getAllProviders().find(p => p.name === 'Inixa') || llmManager.getDefaultProvider();
